...
If you discover a security vulnerability in proto-lint, please follow these steps:

1. **Do NOT** open a public GitHub issue
2. Use [GitHub Security Advisories](https://github.com/fangfengxiang/proto-lint/security/advisories/new) to report privately with:
...
- Vulnerabilities in `proto-lint` source code (`src/`)
- Vulnerabilities in the CLI entry point (`bin/proto-lint`)
