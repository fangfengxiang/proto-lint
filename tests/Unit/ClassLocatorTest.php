...
final class ClassLocatorTest extends TestCase
{
    ...
    public function testResolveByPsr4Scan(): void
    {
        ...
        $path = $locator->resolve('ProtoLint\Test\Fixture\Service\UserService');
    ...
    {
        $locator = new ClassLocator($this->fixtureDir);
        self::assertTrue($locator->exists('ProtoLint\Test\Fixture\Service\UserService'));
    ...
    public function testScanCacheReuse(): void
    {
        ...
        $path1 = $locator->resolve('ProtoLint\Test\Fixture\Dto\UserMessage');
        // Second call should use cache
        $path2 = $locator->resolve('ProtoLint\Test\Fixture\Dto\UserMessage');
